...
" Syntax group
hi Comment      gui=NONE guifg=#0066CC guibg=NONE
hi Constant     gui=NONE guifg=#CC0000 guibg=NONE
hi Error        gui=BOLD guifg=#ffffff guibg=#ff4080
hi Identifier   gui=NONE guifg=#339900 guibg=NONE
hi Ignore       gui=NONE guifg=#f8f8f8 guibg=NONE
hi PreProc      gui=NONE guifg=#660066 guibg=NONE
hi Special      gui=NONE guifg=#660066 guibg=NONE
